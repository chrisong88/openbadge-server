    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(unique=True, max_length=64, db_index=True)),
                ('is_active', models.BooleanField(default=False)),
                ('start_time', models.DecimalField(null=True, max_digits=20, decimal_places=3, blank=True)),
        ...
        migrations.AddField(
            ...
            name='hub',
            field=models.ForeignKey(related_name='current_states', on_delete=django.db.models.deletion.SET_NULL, to='openbadge.Hub', null=True),
        ),
        migrations.AddField(
            model_name='currentstate',
            name='meeting',
            field=models.ForeignKey(related_name='current_states', to='openbadge.Meeting', null=True),
        ),
